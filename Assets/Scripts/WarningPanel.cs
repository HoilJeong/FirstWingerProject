...
public class WarningPanel : BasePanel
{
    ...
    void OnPhaseStay()
    {      
        SystemManager.Instance.GetCurrentSceneMain<FirstWingerSceneMain>().GenerateBoss();
    }
    ...
    {     
        ...
        if (((FWNetworkManager)FWNetworkManager.singleton).isServer)
            SystemManager.Instance.GetCurrentSceneMain<FirstWingerSceneMain>().SetRunningState();
    }
}
