...
public class EnemyManager : MonoBehaviour
{
    ...
    public bool GenerateEnemy(SquadronMemberStruct data)
    {
        ...
        GameObject go = SystemManager.Instance.GetCurrentSceneMain<FirstWingerSceneMain>().EnemyCacheSystem.Archive(FilePath, new Vector3(data.GeneratePointX, data.GeneratePointY, 0));     
    ...
    public bool RemoveEnemy(Enemy enemy)
    {
        ...
        enemy.RemoveList();
        SystemManager.Instance.GetCurrentSceneMain<FirstWingerSceneMain>().EnemyCacheSystem.Restore(enemy.FilePath, enemy.gameObject);
    ...
    public void Prepare()
    {
        ...
        for (int i = 0; i < enemyFiles.Length; i++)
        {
            ...
            SystemManager.Instance.GetCurrentSceneMain<FirstWingerSceneMain>().EnemyCacheSystem.GenerateCache(enemyFiles[i].filePath, go, enemyFiles[i].cacheCount, this.transform);
        }
    }
